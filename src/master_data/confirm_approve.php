<?
  ...
  $sql_update_detail_user = " UPDATE [tbl_knowledge_running]
  SET [knowledge_running_status] = 'APPROVE'
...
WHERE [knowledge_running_code] = '$knowledge_code_ajax'
  ";
  $objQuery_update_running = sqlsrv_query($db_con, $sql_update_detail_user);
  ...
  if($objQuery_update_running){
   //send mail
   $mail = new PHPMailer(true);
   $mail->IsSMTP(); 
              
                       try{
                        $t_subject = "Information from ".$CFG->AppNameTitle." Your Knowledge is Approve.";
                        $body = '
                                ...
                                <center>
                                        <table style="width: 75%; text-align: center; background-color: #fff; padding: 20px;">
                                            ...
                                            <td>
                                                ...
                                                <p style="color: gray; margin-top: -20px;">You have knowledge currently upload is approve.</p>
                                                <p>From: '.$user_approve.' </p>
                                            </td>
                                         </tr>
                                                <tr style="text-align: left;">
                                                 <td>
                                                    <h3 style="text-align: left; margin-top: 10px; margin-bottom: 2px; color: #000;">Knowledge Code: '.$knowledge_code_ajax.'</h3> 
                                                    ...
                                                    <h3 style="text-align: left; margin-top: 10px; margin-bottom: 2px; color: #000;">Knowledge Approve Date: '.$buffer_date.'</h3>
                                                </td>
                                                </tr>
                                                <tr>
